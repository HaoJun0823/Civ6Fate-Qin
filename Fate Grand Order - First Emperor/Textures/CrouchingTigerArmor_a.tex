...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="H:\fe\tex\CrouchingTigerArmor_a.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>581297806</m_ExportedTime>
	<m_ClassName text="Generic_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="CrouchingTigerArmor_a.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="CrouchingTigerArmor_a"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
